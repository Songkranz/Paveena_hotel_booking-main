            ...
            <section class="report-section report-recent">
                <div class="report-section-heading">
                    <div>
                        ...
                        <h2>รายการจองในช่วงที่เลือก</h2>
                    </div>
                    <span><?= htmlspecialchars($sort_label) ?> · สูงสุด 10 รายการ</span>
                </div>
                <?php if (!$recent): ?>
                    ...
                    <div class="report-table-wrap">
                        <table class="report-table">
                            ...
                            <?php foreach ($recent as $row): ?>
                                <tr>
                                    <td><?= str_pad((string)$row['id'], 3, '0', STR_PAD_LEFT) ?></td>
